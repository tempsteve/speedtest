...
function changeServer(server) {
    ...
    speedtestSettings.telemetry_extra = JSON.stringify({
        server: server.name
    }); //add server name as extra data in the telemetry
}
...
function startStop() {
    if (w != null) {
        ...
        w = new Worker('js/speedtest_worker.min.js');
